...
from DataWrapper.settings import CITY, REGIONLIST
...
BASE_URL = u"http://%s.lianjia.com/" % (CITY)
...
def get_house_percommunity(communityname):
    ...
    if total_pages == None:
        row = models.Houseinfo.objects().count()
    ...
    for page in range(total_pages):
        ...
        with models.database.atomic():
            ...
            models.Hisprice.insert_many(hisprice_data_source).upsert().execute()
        time.sleep(1)

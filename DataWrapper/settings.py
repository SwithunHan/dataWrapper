"""
Django settings for DataWrapper project.
...
SECRET_KEY = 'x!w2743bxk#eh$v#j!fyblg(fza1!_kzh20_ag7fpbywb3en#t'
...
WSGI_APPLICATION = 'DataWrapper.wsgi.application'
